...
<div class="col-md-12">
     ...
     {{ !is_null($clothes) ? 'Update clothes :'.$clothes->name: 'New Clothes'}}    
          </div>
              <div class="card-body">
                  <form action="{{ (!is_null($clothes)) ? route('update-cloth',['id'=>$clothes->id]) : route('new-cloth') }}  " method="post" enctype="multipart/form-data">
                    @csrf
                    @if (!is_null($clothes))
                        <input type="hidden" name="_method" value="put"/>
                        <input type="hidden" name="cloth_id" value="{{$clothes->id}}">
                    @endif
                       ...
                       <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-6">
                              ...
                              value="{{(!is_null($clothes)) ? $clothes->quantity : ''}}">
                         </div>
